...
<form action="HalamanBMI.php" method="GET">
  ...
  <div class="form-group row">
    <label for="kode" class="col-4 col-form-label"><b>Kode Pasien</b></label> 
    <div class="col-8">
      <input id="kode" name="kode" placeholder="Masukkan Kode" type="text" class="form-control" required="required">
    </div>
  </div>
  <div class="form-group row">
    <label for="berat" class="col-4 col-form-label"><b>Berat Badan</b></label> 
    <div class="col-8">
      <input id="berat" name="berat" type="text" class="form-control" required="required">
    </div>
  </div>
  <div class="form-group row">
    <label for="tinggi" class="col-4 col-form-label"><b>Tinggi Badan</b></label> 
    <div class="col-8">
      <input id="tinggi" name="tinggi" type="text" class="form-control" required="required">
    </div>
  </div>
  <div class="form-group row">
    <label for="umur" class="col-4 col-form-label"><b>Umur</b></label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="tanggal" class="col-4 col-form-label"><b>Tanggal Periksa</b></label> 
    <div class="col-8">
      <input id="tanggal" name="tanggal" placeholder="yyyy-mm-dd" type="text" class="form-control" required="required">
    </div>
  </div> 
  <div class="form-group row">
